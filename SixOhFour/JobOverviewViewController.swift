...
//        jobs = dataManager.fetch("Job") as! [Job]
    ...
    func calculateWorkTimeDaysAgo(daysAgo: Double) {
        ...
        let predicateTime = NSPredicate(format: " time > %@", NSDate().dateByAddingTimeInterval(-daysAgo * secondsPerDay) )
